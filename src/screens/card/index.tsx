...
export default function Card({ navigation }: any) {
  ...
  const getData = async () => {
    ...
    const result = await axios.get(CONFIG.base_url_api + `/user/list?email=${login?.email}`, {
    ...
    <ScrollView
      ...
      <View
        ...
        <View style={{ width: "100%", paddingHorizontal: normalize(20), marginTop: normalize(20) }}>
          <Text style={{ color: COLOR.darkGrey, textAlign: "left", fontSize: normalize(18), fontWeight: "bold" }}>Telepon: {detail?.phone}</Text>
          <Text style={{ color: COLOR.darkGrey, textAlign: "left", fontSize: normalize(18), fontWeight: "bold", marginTop: normalize(10) }}>Email: {detail?.email}</Text>
        </View>
        {
          path == "profile" ?
            ...
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", width: "100%", marginTop: normalize(30), paddingHorizontal: normalize(20) }}>
                <TouchableOpacity style={{ width: "50%" }} onPress={() => {
                  ...
                  <Text style={{ color: COLOR.darkGrey, fontSize: normalize(18), textAlign: "center", fontWeight: "bold" }}>Profil</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ width: "50%" }} onPress={() => {
                  setPath("invite")
                }}>
                  <Text style={{ color: COLOR.blue, fontSize: normalize(18), textAlign: "center", fontWeight: "bold" }}>Ajak Teman</Text>
                  <View style={{ width: "100%", height: normalize(1), backgroundColor: COLOR.blue, padding: 1, marginTop: normalize(20) }} />
                </TouchableOpacity>
              </View>
